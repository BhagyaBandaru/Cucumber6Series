...
public class AccountsPageSteps {
	...
	public void user_has_already_logged_in_to_application(DataTable credTable) {
		...
		//This is coming from featurefile
	...
	public void user_is_on_accounts_page() {
		/**
		 * Accounts page extends commonpage that is why we directly called this method
		 * with out using/creating commonpage
		 * getPageTitle method is coming from Commonpage
		 */
